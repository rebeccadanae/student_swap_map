...
d3.selection.prototype.moveToFront = function() {
    ...
    var colors = ['#023147','#00649f','#1e8ad6','#5aadf6','#bfdffc']
    var legend_cats = ["-55.4 to -44.2", "-44.1 to -33.0", "-32.9 to -21.8", "-21.7 to -10.6", "-10.5 to 0.7"]
      ...
      function create_map(){
				...
				function getTooltipColorScale(index) {
					var extent = getExtent(index),
						colors = ['#023147','#00649f','#1e8ad6','#5aadf6','#bfdffc'],
      ...
      function build_legend(){
        ...
        var circle_x = [20, 130, 240, 350, 460]
        ...
        var legend_svg = d3
          ...
          legend_svg.selectAll("myrect")
            ...
            legend_svg
            .append("text")
            .text("at flagship public institutions, 2002–18")
            .attr("text-anchor", "middle")
            .attr("x", "50%")
            .attr("y", 40)
            .classed("bold", true)
